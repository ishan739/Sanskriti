...
val leaders = listOf(
    Leader("gandhi", "Mahatma Gandhi", "Father of the Nation", "1869-1948", "Leader of the Indian independence movement, known for his philosophy of nonviolent civil disobedience.", listOf("Non-violence", "Satyagraha"), R.drawable.ic_mahatama, Color(0xFF4CAF50), Brush.linearGradient(listOf(Color(0xFF66BB6A), Color(0xFF4CAF50)))),
    Leader("nehru", "Jawaharlal Nehru", "First Prime Minister", "1889-1964", "A central figure in Indian politics before and after independence, serving as India's first Prime Minister.", listOf("Visionary", "Modern India"), R.drawable.ic_nehru, Color(0xFF2196F3), Brush.linearGradient(listOf(Color(0xFF64B5F6), Color(0xFF2196F3)))),
    Leader("patel", "Sardar Vallabhbhai Patel", "Iron Man of India", "1875-1950", "Played a leading role in the country's struggle for independence and guided its integration into a united, independent nation.", listOf("Integration", "Leadership"), R.drawable.ic_patel, Color(0xFF795548), Brush.linearGradient(listOf(Color(0xFF8D6E63), Color(0xFF795548)))),
    ...
    Leader("lakshmibai", "Rani Lakshmibai", "Queen of Jhansi", "1828-1858", "One of the leading figures of the Indian Rebellion of 1857 and became a symbol of resistance to the British Raj for Indian nationalists.", listOf("Warrior", "Courage"), R.drawable.ic_rani, Color(0xFFE91E63), Brush.linearGradient(listOf(Color(0xFFF06292), Color(0xFFE91E63)))),
    Leader("ambedkar", "Dr. B. R. Ambedkar", "Architect of the Constitution", "1891-1956", "An Indian jurist, economist, politician and social reformer who inspired the Dalit Buddhist movement and campaigned against social discrimination.", listOf("Equality", "Law"), R.drawable.ic_bheem, Color(0xFF3F51B5), Brush.linearGradient(listOf(Color(0xFF7986CB), Color(0xFF3F51B5)))),
    ...
    Leader("indira", "Indira Gandhi", "Iron Lady of India", "1917-1984", "The first and, to date, only female Prime Minister of India, she was a central figure of the Indian National Congress.", listOf("Politics", "Strength"), R.drawable.ic_indira, Color(0xFF009688), Brush.linearGradient(listOf(Color(0xFF4DB6AC), Color(0xFF009688)))),
